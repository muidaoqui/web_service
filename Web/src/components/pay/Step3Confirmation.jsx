...
const Step3Confirmation = ({ plan, selectedYear, getDiscountPrice, userForm, employeeCode, onBack, onNext }) => (
    <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1 bg-white rounded shadow p-6">
            ...
            <div className="mb-4">
                ...
                <div>Giá: <b>{getDiscountPrice(selectedYear).toLocaleString('vi-VN')}đ</b></div>
            </div>
            <div className="mb-4">
